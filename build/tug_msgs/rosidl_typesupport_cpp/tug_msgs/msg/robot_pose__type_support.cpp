...
static const _RobotPose_type_support_symbol_names_t _RobotPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tug_msgs, msg, RobotPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tug_msgs, msg, RobotPose)),
  }
};
...
{
  return &::tug_msgs::msg::rosidl_typesupport_cpp::RobotPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tug_msgs, msg, RobotPose)() {
  return get_message_type_support_handle<tug_msgs::msg::RobotPose>();
}
