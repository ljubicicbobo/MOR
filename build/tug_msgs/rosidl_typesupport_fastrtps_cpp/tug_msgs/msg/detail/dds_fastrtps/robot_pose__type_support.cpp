...
#include "tug_msgs/msg/detail/robot_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tug_msgs::msg::RobotPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tug_msgs::msg::RobotPose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tug_msgs::msg::RobotPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tug_msgs::msg::RobotPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tug_msgs::msg::RobotPose *>(
    untyped_ros_message);
...
{
  return &tug_msgs::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tug_msgs, msg, RobotPose)() {
  return &tug_msgs::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
