...
#include "tug_msgs/msg/detail/movement__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tug_msgs::msg::Movement;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tug_msgs::msg::Movement *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tug_msgs::msg::Movement *>(
    untyped_ros_message);
...
{
  return &tug_msgs::msg::typesupport_fastrtps_cpp::_Movement__handle;
}
