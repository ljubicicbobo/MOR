...
{
  new (message_memory) tug_msgs::msg::Movement(_init);
}

void Movement_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tug_msgs::msg::Movement *>(message_memory);
  typed_message->~Movement();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Movement_message_member_array[1] = {
  {
    "mode",  // name
    ...
    offsetof(tug_msgs::msg::Movement, mode),  // bytes offset in struct
...
get_message_type_support_handle<tug_msgs::msg::Movement>()
{
  return &::tug_msgs::msg::rosidl_typesupport_introspection_cpp::Movement_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tug_msgs, msg, Movement)() {
  return &::tug_msgs::msg::rosidl_typesupport_introspection_cpp::Movement_message_type_support_handle;
}
