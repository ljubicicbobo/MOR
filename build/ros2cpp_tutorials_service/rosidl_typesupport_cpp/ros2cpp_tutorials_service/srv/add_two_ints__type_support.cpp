...
static const _AddTwoInts_Request_type_support_symbol_names_t _AddTwoInts_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2cpp_tutorials_service, srv, AddTwoInts_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2cpp_tutorials_service, srv, AddTwoInts_Request)),
  }
};
...
{
  return &::ros2cpp_tutorials_service::srv::rosidl_typesupport_cpp::AddTwoInts_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2cpp_tutorials_service, srv, AddTwoInts_Request)() {
  return get_message_type_support_handle<ros2cpp_tutorials_service::srv::AddTwoInts_Request>();
}
...
static const _AddTwoInts_Response_type_support_symbol_names_t _AddTwoInts_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2cpp_tutorials_service, srv, AddTwoInts_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2cpp_tutorials_service, srv, AddTwoInts_Response)),
  }
};
...
{
  return &::ros2cpp_tutorials_service::srv::rosidl_typesupport_cpp::AddTwoInts_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2cpp_tutorials_service, srv, AddTwoInts_Response)() {
  return get_message_type_support_handle<ros2cpp_tutorials_service::srv::AddTwoInts_Response>();
}
...
static const _AddTwoInts_type_support_symbol_names_t _AddTwoInts_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2cpp_tutorials_service, srv, AddTwoInts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2cpp_tutorials_service, srv, AddTwoInts)),
  }
};
...
{
  return &::ros2cpp_tutorials_service::srv::rosidl_typesupport_cpp::AddTwoInts_service_type_support_handle;
}
